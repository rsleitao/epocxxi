            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:gap-1 sm:ms-10">
                    ...
                    <x-dropdown align="left" width="w-52" contentClasses="py-1">
                        <x-slot name="trigger">
                            <span class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 cursor-pointer transition duration-150 ease-in-out {{ request()->routeIs('orcamentos.*') ? 'border-epoc-primary text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                                Orçamentos
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('orcamentos.index')">Orçamentos</x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                    ...
                    <x-dropdown align="left" width="w-52" contentClasses="py-1">
                        <x-slot name="trigger">
                            <span class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 cursor-pointer text-gray-500 hover:text-gray-700 hover:border-gray-300 transition duration-150 ease-in-out">
                                Processos
                                <svg class="ms-0.5 h-4 w-4" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>
                            </span>
                        </x-slot>
                        <x-slot name="content">
                            <div class="px-4 py-2 text-xs text-gray-500">Em breve</div>
                        </x-slot>
                    </x-dropdown>
                    ...
                    <x-dropdown align="left" width="w-52" contentClasses="py-1">
                        <x-slot name="trigger">
                            <span class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 cursor-pointer transition duration-150 ease-in-out {{ request()->routeIs('servicos.*') ? 'border-epoc-primary text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                                Trabalhos
                                <svg class="ms-0.5 h-4 w-4" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>
                            </span>
                        </x-slot>
