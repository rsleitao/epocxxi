...
<div class="space-y-4">
    ...
    <div>
        ...
        <x-text-input id="nif" name="nif" type="text" class="mt-1 block w-full"
                      value="{{ old('nif', $subcontratado?->nif) }}" />
    ...
    <div>
        ...
        <x-text-input id="morada" name="morada" type="text" class="mt-1 block w-full"
                      value="{{ old('morada', $subcontratado?->morada) }}" />
